...
const OfferItem: FC<{ id: string; title: string; text: string; reverse?: boolean }> = ({ id, title, text, reverse }) => {
    ...
    return (
        <div className={classNames(styles.offers_item, reverse && styles.offers_item_reverse)} id={id}>
            ...
            <img src={Img} className={styles.offers_item_img} alt={`${title} image`} />
