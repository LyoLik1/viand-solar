    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.values}>
                <div className={classNames(styles.value, styles.quality)}>
                ...
                <div className={classNames(styles.value, styles.safety)}>
                ...
                <div className={classNames(styles.value, styles.comfort)}>
